    ...
    if (raycaster) {
      ...
      if (intersects.length > 0) {
        if (this.INTERSECTED !== intersects[0].object) {
          if (this.INTERSECTED) {
            (this.INTERSECTED as THREE.Mesh).material.emissive.setHex(
              (this.INTERSECTED as THREE.Mesh).currentHex,
            );
          }
          this.INTERSECTED = intersects[0].object as THREE.Mesh;
          this.INTERSECTED.currentHex = (this.INTERSECTED as THREE.Mesh)
